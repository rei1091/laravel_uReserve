                    ...
                    <form method="POST" action="{{ route('events.update', ['event' => $event->id]) }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-textarea row="3" id="information" name="information"
                                class="block mt-1 w-full">{{ $event->information }}</x-textarea>
                        </div>
                        ...
                        <div class="md:flex justify-between items-end">
                            ...
                            <div class="md:flex space-x4 justify-around">
                                <input type="radio" name="is_visible" value="1"
                                    @if ($event->is_visible === 1) { checked
                                } @endif />表示
                                <input type="radio" name="is_visible" value="0"
                                    @if ($event->is_visible === 0) { checked
                                } @endif />非表示
                            </div>
